-- =============================================================
-- HireFlow AI — PostgreSQL Schema DDL
...
CREATE TABLE users (
    ...
    avatar_url      TEXT,
    oauth_provider  VARCHAR(50),                   -- 'google', NULL for local
    oauth_subject   VARCHAR(255),                  -- Google sub claim
...
-- Ranked applicants convenience view
